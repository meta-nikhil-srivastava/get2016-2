...
public class TemperatureConversionServiceLocator extends org.apache.axis.client.Service implements web.TemperatureConversionService {
    ...
    private java.lang.String TemperatureConversion_address = "http://localhost:8080/WebServices/services/TemperatureConversion";
    ...
    public web.TemperatureConversion getTemperatureConversion(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            web.TemperatureConversionSoapBindingStub _stub = new web.TemperatureConversionSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (web.TemperatureConversion.class.isAssignableFrom(serviceEndpointInterface)) {
                web.TemperatureConversionSoapBindingStub _stub = new web.TemperatureConversionSoapBindingStub(new java.net.URL(TemperatureConversion_address), this);
                _stub.setPortName(getTemperatureConversionWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://web", "TemperatureConversionService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://web", "TemperatureConversion"));
        }
